...
if __name__ == '__main__':
    ...
    print("--------------------------")
    """
        Please run the code several times as the next state is determined
    by the dynamics of the environment step, which involves a random event (sale or no sale),
